  ...
  render() {
    return (
      ...
      <Switch>
        ...
        <Route exact path="/create-mashup" component={(...props) => <MashupCreate {...props} history={this.props.history} loggedUser={this.state.loggedUser} selectedMashup={this.state.selectedMashup}/>}/>
