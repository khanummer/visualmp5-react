...
//     e.preventDefault();
//         try {
//             const response = await fetch(`https://localhost:4000/api/lastFM/search/${this.state.search}`, {
//             method: 'GET',
//             headers: {
    ...
    render() {
      return (
        <div className="Search">
          <div className="coming-soon-dark">-----COMING SOON-----</div>
          <div className="Search-title">SEARCH FOR A SONG</div>
          <div className="Search-undertitle">AND RECIEVE VISUALS ASSOCIATED WITH THAT SONG</div>
              <form className="Search-Form">
                <input className="Search-Input"type="text"/>
                <br></br><button className="Search-Button">Submit</button>
